...
<strong>Computer Science Graduate (GSU class of '18)</strong> experienced in building software with <strong></strong>Java, C, x86 (Assembly), JavaScript (Vue, Nuxt, React, Electron and Angular) and Python.</strong> Even though I’ve gained experience in these other languages, Java will always be my first love.<br/><br/>
